<template>
  <article class="pa3 pa5-ns">
    <nav class="flex justify-between bb b--white-10">
      <NuxtLink class="f6 link dim br3 ba bw1 ph3 pv2 mb2 dib black" to="/HomeNDI">Nel Dominio dell'Incerto</NuxtLink>
      <!-- <div class="flex-grow pa3 flex items-center">
        <AppSearchInputNDI class="f6 link dib white dim mr3 mr4-ns"/>
      </div> -->
    </nav>
...
export default {
  async asyncData({ $content, params }) {
    const article = await $content('articlesNDI', params.slug).fetch()
