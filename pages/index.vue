  ...
  <header class="sans-serif">
    <div class="vh-100 w-100 cover bg-left bg-center" style="background-image no-repeat center">
      ...
      <div class="flex justify-center pt6">
        <a class="w4 h4 pt7 grow-large border-box" href='http://www.greengeeks.com' alt='GreenGeeks' rel='nofollow'><img src='https://ads.greengeeks.com/Green_11.png' border='0'></a>
      </div>
    </div>
  </header>
</template>
